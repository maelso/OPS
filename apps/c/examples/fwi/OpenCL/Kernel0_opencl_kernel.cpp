...
static bool isbuilt_Kernel0 = false;

void buildOpenCLKernels_Kernel0(int xdim0, int xdim1, int xdim2, int xdim3, int xdim4) {
  ...
  if(!isbuilt_Kernel0) {
    ...
    cl_int ret;
    char* source_filename[1] = {(char*)"./OpenCL/Kernel0.cl"};
    ...
    printf("Compiling Kernel0 %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_Kernel0=%d  -Dxdim1_Kernel0=%d  -Dxdim2_Kernel0=%d  -Dxdim3_Kernel0=%d  -Dxdim4_Kernel0=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
        else
          sprintf(buildOpts,"-cl-mad-enable -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_Kernel0=%d  -Dxdim1_Kernel0=%d  -Dxdim2_Kernel0=%d  -Dxdim3_Kernel0=%d  -Dxdim4_Kernel0=%d ", pPath, 32,xdim0,xdim1,xdim2,xdim3,xdim4);
      else {
      ...
      printf("compiling Kernel0 -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[0] = clCreateKernel(OPS_opencl_core.program, "ops_Kernel0", &ret);
    clSafeCall( ret );

    isbuilt_Kernel0 = true;
  }
...
// host stub function
void ops_par_loop_Kernel0(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4) {
  ...
  if (globalWorkSize[0]>0 && globalWorkSize[1]>0 && globalWorkSize[2]>0) {
    ...
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 5, sizeof(cl_float), (void*) &dt ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 6, sizeof(cl_int), (void*) &base0 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 7, sizeof(cl_int), (void*) &base1 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 8, sizeof(cl_int), (void*) &base2 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 9, sizeof(cl_int), (void*) &base3 ));
    clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[0], 10, sizeof(cl_int), (void*) &base4 ));
